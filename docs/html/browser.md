...
![进程1](https://segmentfault.com/img/remote/1460000022633991)
...
![进程关系](https://segmentfault.com/img/remote/1460000022633994)
...
![浏览器容错性](https://segmentfault.com/img/remote/1460000022633993)
...
![浏览器进程线程](https://segmentfault.com/img/remote/1460000022633997)

#### 第一步：处理输入

当我们在浏览器的地址栏输入内容按下回车时，`UI thread`会判断输入的内容是搜索关键词（search query）还是URL，如果是搜索关键词，跳转至默认搜索引擎对应都搜索URL，如果输入的内容是URL，则开始请求URL。

![处理输入](https://segmentfault.com/img/remote/1460000022633995)
...
![开始导航](https://segmentfault.com/img/remote/1460000022633996)
...
![查找渲染进程](https://segmentfault.com/img/remote/1460000022633999)
...
![提交导航](https://segmentfault.com/img/remote/1460000022634000)
...
![浏览器进程中线程](https://segmentfault.com/img/remote/1460000022633998)
...
![加载子资源](https://segmentfault.com/img/remote/1460000022634001)
...
![样式计算](https://segmentfault.com/img/remote/1460000022634002)
...
![layout](https://segmentfault.com/img/remote/1460000022634004)
...
![paint](https://segmentfault.com/img/remote/1460000022634003)
...
![最简单的光栅化过程](https://segmentfault.com/img/remote/1460000022634005)
...
![layer tree](https://segmentfault.com/img/remote/1460000022634010)
...
![光栅线程创建图块的位图并发送给GPU](https://segmentfault.com/img/remote/1460000022634009)
...
![合成线程构建出合成帧，合成帧会被发送给浏览器进程然后再发送给GPU](https://segmentfault.com/img/remote/1460000022634011)
...
![点击事件从浏览器进程路由到渲染进程](https://segmentfault.com/img/remote/1460000022634008)
...
![非快速滚动区域有用户事件发生](https://segmentfault.com/img/remote/1460000022634007)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](https://segmentfault.com/img/remote/1460000022634012)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](https://segmentfault.com/img/remote/1460000022634013)
...
![事件淹没了屏幕刷新的时间轴，导致页面很卡顿](https://segmentfault.com/img/remote/1460000022634015)

出于优化的目的，浏览器会合并这些连续的事件，延迟到下一帧渲染是执行，也就是`requestAnimationFrame`之前。

![和之前相同的事件轴，可是这次事件被合并并延迟调度了](https://segmentfault.com/img/remote/1460000022634014)

而对于非连续性的事件，如keydown，keyup，mousedown，mouseup，touchstart，touchend等，会直接派发给主线程去执行。

> 转自: https://segmentfault.com/a/1190000022633988