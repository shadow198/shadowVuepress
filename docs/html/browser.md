...
![进程1](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633991.png)
...
![进程关系](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633994.png)
...
![进程关系](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633992.png)
...
![浏览器容错性](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633993.png)
...
- **site** 指的是相同的 registered domain name(如： google.com ，bbc.co.uk)和scheme (如：[https://)](https://link.segmentfault.com/?url=https%3A%2F%2F))。比如a.baidu.com和b.baidu.com就可以理解为同一个 site（注意这里要和 [Same-origin policy](https://link.segmentfault.com/?url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FSecurity%2FSame-origin_policy) 区分开来，同源策略还涉及到子域名和端口）。
...
![浏览器进程线程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633997.png)

#### 第一步：处理输入

当我们在浏览器的地址栏输入内容按下回车时，`UI thread`会判断输入的内容是搜索关键词（search query）还是URL，如果是搜索关键词，跳转至默认搜索引擎对应都搜索URL，如果输入的内容是URL，则开始请求URL。

![处理输入](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633995.png)
...
![开始导航](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633996.png)
...
与此同时，浏览器会进行 [Safe Browsing](https://link.segmentfault.com/?url=https%3A%2F%2Fsafebrowsing.google.com%2F) 安全检查，如果域名或者请求内容匹配到已知的恶意站点，network thread 会展示一个警告页。除此之外，网络线程还会做 [CORB](https://link.segmentfault.com/?url=https%3A%2F%2Fwww.chromium.org%2FHome%2Fchromium-security%2Fcorb-for-developers)（Cross Origin Read Blocking）检查来确定那些敏感的跨站数据不会被发送至渲染进程。

#### 第四步：查找渲染进程

各种检查完毕以后，network thread 确信浏览器可以导航到请求网页，network thread 会通知 UI thread 数据已经准备好，UI thread 会查找到一个 renderer process 进行网页的渲染。

![查找渲染进程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633999.png)
...
![提交导航](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634000.png)
...
![浏览器进程中线程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022633998.png)
...
![加载子资源](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634001.png)
...
![样式计算](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634002.png)
...
![layout](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634004.png)
...
![paint](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634003.png)
...
![最简单的光栅化过程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634005.gif)
...
![合成的光栅化过程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634006.gif)
...
![layer tree](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634010.png)
...
![光栅线程创建图块的位图并发送给GPU](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634009.png)
...
![合成线程构建出合成帧，合成帧会被发送给浏览器进程然后再发送给GPU](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634011.png)

合成的好处在于这个过程没有涉及到主线程，所以合成线程不需要等待样式的计算以及JavaScript完成执行。这就是为什么[合成器相关的动画](https://link.segmentfault.com/?url=https%3A%2F%2Fwww.html5rocks.com%2Fen%2Ftutorials%2Fspeed%2Fhigh-performance-animations%2F)最流畅，如果某个动画涉及到布局或者绘制的调整，就会涉及到主线程的重新计算，自然会慢很多。
...
![点击事件从浏览器进程路由到渲染进程](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634008.png)
...
![非快速滚动区域有用户事件发生](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634007.png)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634012.png)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634013.png)
...
![事件淹没了屏幕刷新的时间轴，导致页面很卡顿](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634015.png)

出于优化的目的，浏览器会合并这些连续的事件，延迟到下一帧渲染是执行，也就是`requestAnimationFrame`之前。

![和之前相同的事件轴，可是这次事件被合并并延迟调度了](C:\Users\Administrator\Documents\GitHub\shadowVuepress\docs\html\browser.assets\1460000022634014.png)
